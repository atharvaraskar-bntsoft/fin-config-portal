...
@Component({
  selector: 'app-instituion-details',
  templateUrl: './instituion-details.component.html',
  styleUrls: ['./instituion-details.component.css']
})
export class InstituionDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._store.dispatch(new GetInstitutionDetail(this.id));
  }
  ...
  // && Object.keys(row.additionalAttribute).map((k) => {
  //     ​​​​return {​​​​ [k]: row.additionalAttribute[k]}​​​​}​​​​)​​​;

...
import { TransformJsonComponent } from './transform-json.component';
...
describe('L3TransformJsonComponent', () => {
  let component: TransformJsonComponent;
  let fixture: ComponentFixture<TransformJsonComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [TransformJsonComponent],
      providers: [
        AlertService,
        SnotifyService,
        L1AdapterService,
    ...
    fixture = TestBed.createComponent(TransformJsonComponent);

...
import { TransformActionComponent } from './transform-action.component';
...
import { selectElFunction } from '@app/store/selectors/scheme-imf-mapper.selectors';
...
describe('TransformActionComponent', () => {
  let component: TransformActionComponent;
  let fixture: ComponentFixture<TransformActionComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [TransformActionComponent],
      providers: [
        AlertService,
        SnotifyService,
        L1AdapterService,
    ...
    fixture = TestBed.createComponent(TransformActionComponent);

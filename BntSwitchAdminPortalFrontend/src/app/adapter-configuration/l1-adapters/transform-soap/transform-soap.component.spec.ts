...
import { TransformSOAPComponent } from './transform-soap.component';
...
describe('TransformSOAPComponent', () => {
  let component: TransformSOAPComponent;
  let fixture: ComponentFixture<TransformSOAPComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [TransformSOAPComponent],
      providers: [
        AlertService,
        SnotifyService,
        L1AdapterService,
    ...
    fixture = TestBed.createComponent(TransformSOAPComponent);

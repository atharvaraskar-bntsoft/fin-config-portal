...
import { selectInternalCode, selectL1AdapterData } from '@app/store/selectors/l1-adapter.selectors';
...
describe('ResponseCodeTabComponent', () => {
  ...
  beforeEach(() => {
    ...
    mockselectInternalCode = mockStore.overrideSelector(selectInternalCode, ipcJson);
    ...
    component.internalCodeList = ipcJson;
    // component.isEdit = true;

    // component.responseCodeData = adapterDataJson.data.responseCodeData;
    // component.responseCodeData.ipcUiWrapper = adapterDataJson.data.responseCodeData.ipcUiWrapper;
    // component.responseCodeList = component.responseCodeData.ipcUiWrapper.ipcList;
  ...
  it('fuction should click response tab ', () => {
    const flag = true;
    component.draftResponse(flag);
    expect(component.adapterData.networkData).toBeDefined;
  });
  it('fuction should call check version data ', () => {
    component.versionData();
    expect(component.responseCodeList).toBeDefined;
  });
  it('fuction should validate responese code tab in html', () => {
    const i = 1;
    component.pullresponseCodeItem(i);
    expect(component.responseCodeData.persistRequired).toEqual(1);
  });
  it('fuction should validate responese code tab in html', () => {
    component.pushresponseCodeItem();
    expect(component.responseCodeData.persistRequired).toEqual(1);
  });
  it('fuction should validate responese code tab in html', () => {

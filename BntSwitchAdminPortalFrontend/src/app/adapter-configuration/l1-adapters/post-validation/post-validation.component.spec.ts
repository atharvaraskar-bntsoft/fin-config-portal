...
import { CUSTOM_ELEMENTS_SCHEMA, EventEmitter, inject, NO_ERRORS_SCHEMA } from '@angular/core';
import { of } from 'rxjs';
...
const selectViewSettingsListJSON = {
  ...
  data: {
    ...
    settingDto: {
      id: 1,
      systemUserId:
        'SystemUser [firstName=BnttName=Admin, email=bnt.admin@bnt.com, systemUserCategory=, password=9AHRz1ElALzTEdFKIKywyzEZh0IcZ/INhbGkbc0Qb84=, passwordLastUpdatedOn=2020-07-02 13:09:08.0, locked=0, deleted=0, lockedReason=null]',
      search: 'contain',
      language: 'en_EN1',
      pagination: '20',
    },

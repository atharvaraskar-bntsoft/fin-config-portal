...
export class ArrayActionComponent implements OnInit {
  ...
  public closeParamPopup(event) {
    if (!event.data.parametersOptional) {
      if (!this.isRequest) {

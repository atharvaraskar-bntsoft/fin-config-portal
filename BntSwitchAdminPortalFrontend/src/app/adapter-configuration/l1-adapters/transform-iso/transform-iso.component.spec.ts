...
import { TransformIsoComponent } from './transform-iso.component';
...
describe('TransformIsoComponent', () => {
  let component: TransformIsoComponent;
  let fixture: ComponentFixture<TransformIsoComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [TransformIsoComponent],
      providers: [
        AlertService,
        SnotifyService,
        L1AdapterService,
    ...
    fixture = TestBed.createComponent(TransformIsoComponent);

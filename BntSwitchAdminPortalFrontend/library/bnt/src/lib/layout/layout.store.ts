...
export class LayoutStore {
  ...
  get windowInnerHeight(): Observable<number> {
    return <Observable<number>>(
      this.layoutState.pipe(pluck('windowInnerHeight'), distinctUntilChanged())
    );
  }
  ...
  get windowInnerWidth(): Observable<number> {
    return <Observable<number>>(
      this.layoutState.pipe(pluck('windowInnerWidth'), distinctUntilChanged())
    );
  }
  ...
  get isSidebarLeftCollapsed(): Observable<boolean> {
    return <Observable<boolean>>(
      this.layoutState.pipe(pluck('isSidebarLeftCollapsed'), distinctUntilChanged())
    );
  }
  ...
  get isSidebarLeftExpandOnOver(): Observable<boolean> {
    return <Observable<boolean>>(
      this.layoutState.pipe(pluck('isSidebarLeftExpandOnOver'), distinctUntilChanged())
    );
  }
  ...
  get isSidebarLeftMouseOver(): Observable<boolean> {
    return <Observable<boolean>>(
      this.layoutState.pipe(pluck('isSidebarLeftMouseOver'), distinctUntilChanged())
    );
  }
  ...
  get isSidebarLeftMini(): Observable<boolean> {
    return <Observable<boolean>>(
      this.layoutState.pipe(pluck('isSidebarLeftMini'), distinctUntilChanged())
    );
  }
  ...
  get sidebarRightSkin(): Observable<string> {
    return <Observable<string>>(
      this.layoutState.pipe(pluck('sidebarRightSkin'), distinctUntilChanged())
    );
  }
  ...
  get isSidebarRightCollapsed(): Observable<boolean> {
    return <Observable<boolean>>(
      this.layoutState.pipe(pluck('isSidebarRightCollapsed'), distinctUntilChanged())
    );
  }
  ...
  get isSidebarRightOverContent(): Observable<boolean> {
    return <Observable<boolean>>(
      this.layoutState.pipe(pluck('isSidebarRightOverContent'), distinctUntilChanged())
    );
  }
  ...
  get sidebarLeftMenu(): Observable<Array<any>> {
    return <Observable<Array<any>>>(
      this.layoutState.pipe(pluck('sidebarLeftMenu'), distinctUntilChanged())
    );
  }
  ...
  get sidebarLeftMenuActiveUrl(): Observable<string> {
    return <Observable<string>>(
      this.layoutState.pipe(pluck('sidebarLeftMenuActiveUrl'), distinctUntilChanged())
    );
  }
  ...
  get sidebarLeftElementHeight(): Observable<number> {
    return <Observable<number>>(
      this.layoutState.pipe(pluck('sidebarLeftElementHeight'), distinctUntilChanged())
    );
  }
  ...
  get wrapperClasses(): Observable<string> {
    return <Observable<string>>(
      this.layoutState.pipe(pluck('wrapperClasses'), distinctUntilChanged())
    );
  }

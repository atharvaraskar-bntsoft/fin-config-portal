 ...
 */
@Component({
  selector: 'rv-layout-footer-left',
 ...
 */
@Component({
  selector: 'rv-layout-footer-right',
  template: '<ng-template #templateRef><ng-content></ng-content></ng-template>',
})
...
export class FooterComponent implements OnInit {
  ...
  constructor(private elementRef: ElementRef, private footerService: FooterService) {}

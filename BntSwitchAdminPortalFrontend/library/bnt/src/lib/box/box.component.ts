...
export class BoxComponent implements AfterViewInit, OnDestroy {
  ...
  @ContentChild(BoxHeaderDirective, { static: true })
  public boxHeaderDirective: BoxHeaderDirective;
  @ContentChild(BoxFooterDirective, { static: true })
  public boxFooterDirective: BoxFooterDirective;
  @ContentChild(BoxContentDirective, { static: true })
  public boxContentDirective: BoxContentDirective;
  @ContentChild(BoxToolsDirective, { static: true })
  public boxToolsDirective: BoxToolsDirective;

  @ViewChild('toggleButtonElement', { static: true })
  private toggleButtonElement;
  @ViewChild('removeButtonElement', { static: true })
  ...
  ngAfterViewInit() {
    this.ngZone.runOutsideAngular(() => {
      if (this.toggleButtonElement) {
        this.listeners.push(
          this.renderer2.listen(this.toggleButtonElement.nativeElement, 'click', () => {
      ...
      if (this.removeButtonElement) {
        this.listeners.push(
          this.renderer2.listen(this.removeButtonElement.nativeElement, 'click', () => {
            this.remove = true;
            this.changeDetectorRef.detectChanges();
          }),
        );

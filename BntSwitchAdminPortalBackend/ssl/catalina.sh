...
JAVA_OPTS="$JAVA_OPTS -Djava.protocol.handler.pkgs=org.apache.catalina.webresources -Dliquibase.secureParsing=false --add-opens java.management/javax.management.remote=ALL-UNNAMED"

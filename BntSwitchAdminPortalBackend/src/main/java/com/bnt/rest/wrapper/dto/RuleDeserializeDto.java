...
public class RuleDeserializeDto {
	...
	public String toString() {
		return "RuleDeserializeDto [startParenthesis=" + startParenthesis + ", endParenthesis=" + endParenthesis
				+ ", selectionCriteriaValue=" + selectionCriteriaValue + ", selectionCriteria=" + selectionCriteria
				+ ", logicalOperator=" + logicalOperator + ", conditionalOperator=" + conditionalOperator
				+ ", txnAmount=" + txnAmount + ", transactionAmt=" + transactionAmt + "]";
	}
}
